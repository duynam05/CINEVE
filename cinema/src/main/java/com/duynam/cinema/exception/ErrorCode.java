...
public enum ErrorCode {
    ...
    ROLE_INVALID(1020, "Vai trò không hợp lệ", HttpStatus.BAD_REQUEST),
    USER_STATUS_REQUIRED(1021, "Trạng thái người dùng không được để trống", HttpStatus.BAD_REQUEST),
    ROLE_REQUIRED(1022, "Vai trò không được để trống", HttpStatus.BAD_REQUEST),
    FILE_UPLOAD_FAILED(1023, "Không thể tải lên tệp tin", HttpStatus.INTERNAL_SERVER_ERROR),
    FILE_SIZE_INVALID(1024, "Kích thước tệp tin vượt quá 2MB", HttpStatus.BAD_REQUEST),
    FILE_TYPE_INVALID(1025, "Định dạng tệp tin không hợp lệ", HttpStatus.BAD_REQUEST),
    ...
    ROOM_HAS_BOOKINGS(3029, "Phòng chiếu đã có đơn đặt vé, không thể tự động sinh lại ghế", HttpStatus.BAD_REQUEST),
    ...
    BOOKING_CANNOT_BE_PAID(7030, "Booking không ở trạng thái chờ thanh toán", HttpStatus.BAD_REQUEST),
    BOOKING_EXPIRED(7031, "Thời gian giữ chỗ đã hết, vui lòng đặt lại", HttpStatus.BAD_REQUEST),
    SHOWTIME_IN_PAST(7032, "Không thể đặt vé cho suất chiếu trong quá khứ", HttpStatus.BAD_REQUEST),
